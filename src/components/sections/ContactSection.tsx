    ...
    <section id="kontakt" className="w-full bg-[#F9F5E7] py-24 lg:py-36">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-16">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#2A1A1A]/60">{CONTACT_CTA.subheading}</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h3 className="font-serif text-4xl lg:text-5xl font-bold text-[#5C1A1B] leading-[1.0] mb-10">
              Gdzie nas<br /><em className="italic">znajdziesz?</em>
            </h3>

            <ContactInfoCard icon="pin" label={CONTACT_ADDRESS.label}>
            ...
            <ContactInfoCard icon="phone" label={CONTACT_PHONE.label}>
              <a href={CONTACT_PHONE.href} className="text-[#2A1A1A]/55 text-sm hover:text-[#5C1A1B] transition-colors">
                {CONTACT_PHONE.display}
              </a>
            </ContactInfoCard>

            <ContactInfoCard icon="email" label={CONTACT_EMAIL.label} className="mb-8">
